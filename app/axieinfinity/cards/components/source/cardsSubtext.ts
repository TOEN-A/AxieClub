...
export const cardsSubtext: ContentMap = {
  ...
  クレンザー: {
    text: [
      'クレンザー: 各スタックは最大4つのデバフスタックまたは4ターンのデバフを防ぐ。',
    ],
    images: [],
  },
  イネイト: {
  ...
  ブリード: {
    text: ['ブリード: このアクシーがカードをプレイする度に、15のHPを失う。'],
    images: [],
  },
  ジンクス: {
    text: [],
  ...
  フェザー: {
    text: [
      'フェザー: ヒットごとに+1DMG、最大+20まで。ターンが終了時、このアクシーが攻撃した場合、-1フェザー。全てのフェザーを失うと、ポーナスDMGが0にリセットされる。最大スタック:10。',
    ],
    images: [],
  },
  ヘックス: {
  ...
  レイジ: {
    text: [
      'レイジ: スタックごとに攻撃はダメージが+1される。攻撃を受けた際には、スタックごとにダメージが+1される。スタックが10になると、すべての、レイジを消費してフューリーの形態に入る。',
      'フューリー: +1のエナジーを獲得する。+50%のダメージを与えるが、エナジーフラグメントを付与することはできす、ターン終了まで、レイジを得ることはできない。',
      'エナジーフラグメント: エナジーフラグメントをたくさん集めると、エナジーバーストが発生する。',
      'エナジーバースト: バーストすると、あなたのターン開始時からバトル終了まで、エナジーを1追加する。',
    ],
    images: [],
  ...
  デスマーク: {
    text: [
      'デスマーク: 敵が攻撃力ードをプレイする度に、その攻撃のエナジーコストごとに15のビュアダメージを受ける。',
  ...
  グリーバスウーンド: {
    text: [
      ...
      'ブリード: このアクシーがカードをプレイする度に、15のHPを失う。',
    ],
    images: [],
  },
  ランバーシールド: {
  ...
  スネークジャー: {
    text: [
      'スネークジャー: このアクシーが6ターン以内に死亡しない場合、全ての敵に100ダメージを与える。ディスペルできない。',
    ],
    images: [],
  },
  リターン: {
