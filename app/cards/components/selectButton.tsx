  ...
  return (
    <>
      {options.map((option) => (
        <button
          key={option}
          className={"mr-0.5 mt-0.5 text-[0.64rem] md:text-[0.78rem] lg:text-base w-[3.4rem] md:w-16 lg:w-24 px-0 py-2 rounded-full focus:outline-none hover:opacity-75 shadow-md"}
          style={{
